...
def test_mmdp(mmdp_instance):
    ...
    test_cases = [
        (
            [0] * 240,
            1.0,
        ),  # All zeros: 1.0 for each subproblem, total 40, normalized 40/40=1.0
        (
            [1] * 240,
            1.0,
        ),  # All ones: 1.0 for each subproblem, total 40, normalized 40/40=1.0
        (
            [1, 0] * 120,
            0.641,
        ),  # Alternating 1s and 0s, normalized as per problem definition
