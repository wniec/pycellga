...
def test_byte_uniform_crossover(setup_parents, setup_problem):
    ...
    This test checks the byte-level uniform crossover on a pair of parent individuals by verifying the recombination
    ...
    crossover = ByteUniformCrossover(setup_parents, setup_problem)
